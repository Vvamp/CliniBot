...
//Calibrate sensor for line movement
...
void controlGrid(){
    ...
    int getLeft, getFoward, getRight = calibrateSensor(Light3.reflected);
		...
		while (true) {
			...
			if (BP.get_sensor(PORT_2, Ultrasonic2) == 0) {
				if (BP.get_sensor(PORT_3, Light3) == 0) {
					...
					if (Ultrasonic2.cm > 10) {
						if (Light3.reflected >= getFoward && Light3.reflected <= getRight) {
                            if(enableDebug){
                                cout << "half" << endl;
                            }
							//moveFwd(100000);
						...
						else if (Light3.reflected > getLeft && Light3.reflected < getFoward) {
                            if(enableDebug){
                                cout << "wit" << endl;
                            }
							//moveLeft(100000);
						...
						else if (Light3.reflected > getRight) {
                            if(enableDebug){
                                cout << "zwart" << endl;
                            }
                            if(isCrossing()){
...
cout << "|                                               |" << endl;
cout << "|       Selecteer uw keuze met 1 of 2           |" << endl;
cout << "|_______________________________________________|" << endl;
cout << endl;
